...
/***/ 3470:
/*!*************************************************************!*\
  !*** ./src/services/Data-Provider/data-provider.service.ts ***!
  \*************************************************************/
...
DataProviderService = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__decorate)([
...
/***/ 31:
/*!**********************************************!*\
  !*** ./src/services/Stock/stocks.service.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
let StocksService = class StocksService {
    ...
    addStock(data) {
        return (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_1__.addDoc)((0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_1__.collection)(this.fs, _url__WEBPACK_IMPORTED_MODULE_0__.urls.stocks), data);
    }
    editStock(STOCK_ID, data) {
        const editStockUrl = _url__WEBPACK_IMPORTED_MODULE_0__.urls.stock.replace('{STOCK_ID}', STOCK_ID);
        return (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_1__.updateDoc)((0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_1__.doc)(this.fs, editStockUrl), data);
    }
    getStock(STOCK_ID) {
        const getStockUrl = _url__WEBPACK_IMPORTED_MODULE_0__.urls.stock.replace('{STOCK_ID}', STOCK_ID);
        return (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_1__.getDoc)((0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_1__.doc)(this.fs, getStockUrl));
    }
};
StocksService.ctorParameters = () => [
    { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_1__.Firestore }
];
StocksService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
...
/* harmony import */ var _Data_Provider_data_provider_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../Data-Provider/data-provider.service */ 3470);
/* harmony import */ var _url__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../url */ 2123);
...
let UserService = class UserService {
    constructor(auth, dataProvider, fs) {
        this.auth = auth;
        this.dataProvider = dataProvider;
        this.fs = fs;
        this.user = rxjs__WEBPACK_IMPORTED_MODULE_2__.EMPTY;
        if (this.auth) {
            this.user = (0,_angular_fire_auth__WEBPACK_IMPORTED_MODULE_3__.authState)(this.auth);
    ...
    addUser(data) {
        return (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.addDoc)((0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.collection)(this.fs, _url__WEBPACK_IMPORTED_MODULE_1__.urls.users), data);
    }
    getUser(USER_ID) {
        const userIDUrl = _url__WEBPACK_IMPORTED_MODULE_1__.urls.user.replace('{USER_ID}', USER_ID);
        return (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.getDoc)((0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.doc)(this.fs, userIDUrl));
    }
    getAllUsers() {
        return (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.getDocs)((0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.collection)(this.fs, '/users'));
    }
    updateUser(USER_ID, data) {
        const userIDUrl = _url__WEBPACK_IMPORTED_MODULE_1__.urls.user.replace('{USER_ID}', USER_ID);
        return (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.updateDoc)((0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__.doc)(this.fs, userIDUrl), data);
    }
};
UserService.ctorParameters = () => [
    { type: _angular_fire_auth__WEBPACK_IMPORTED_MODULE_3__.Auth },
    { type: _Data_Provider_data_provider_service__WEBPACK_IMPORTED_MODULE_0__.DataProviderService },
...
/* harmony export */ });
/* harmony import */ var F_AngularProjects_phaseTwo_Fmcg_Kcg_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 1670);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,F_AngularProjects_phaseTwo_Fmcg_Kcg_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,F_AngularProjects_phaseTwo_Fmcg_Kcg_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,F_AngularProjects_phaseTwo_Fmcg_Kcg_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
